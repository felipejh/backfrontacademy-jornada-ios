...
var PostMock: [PostData] = [
    ...
    PostData(profileImage: "user2", userName: "Mario", postImage: "tesla", isLiked: false, isSaved: false, caption: "Você acredita?", isVideo: false, videoURL: nil),
    ...
    PostData(profileImage: "user5", userName: "Cleiton", postImage: "sonhos", isLiked: false, isSaved: false, caption: "Você acredita?", isVideo: false, videoURL: nil),
